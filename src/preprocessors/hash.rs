...
mod tests {
    ...
    #[test]
    fn test_hashes() {
        let data = match hex_to_vec("41 72 6d 6f 72 4c 69 62 20 69 73 20 74 68 65 20 63 6f 6f 6c 65 73 74 20 6c 69 62 72 61 72 79 20 69 6e 20 74 68 65 20 77 6f 72 6c 64 21") {
					Ok(vec) => vec ,
						Err(err) => {
							println!("Unable to convert from hex to vec. Error: {}",err);
							return;
						}
				};
