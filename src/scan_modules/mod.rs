...
pub fn make_default_scan_modules() -> Vec<Box<ScanModule>> {
    vec![
        ...
        Box::new(exif::ExifScanModule {}),
				Box::new(exten_check::ExtensionCheckScanModule {}),
				Box::new(passwd_detect::PasswordCheckScanModule {}),
				Box::new(entropy_check::EntropyCheckScanModule {}),
				Box::new(crypto_check::CryptoCheckScanModule {}),
